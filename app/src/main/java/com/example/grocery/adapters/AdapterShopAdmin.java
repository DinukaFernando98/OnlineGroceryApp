...
public class AdapterShopAdmin extends RecyclerView.Adapter<AdapterShopAdmin.HolderShop>{

    private Context context;
    public ArrayList<ModelShop> shopList;

    public AdapterShopAdmin(Context context, ArrayList<ModelShop> shopList) {
