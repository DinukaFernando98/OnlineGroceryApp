...
public class AdapterOrderShop extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable{
    ...
    public AdapterOrderShop(Context context, ArrayList<ModelOrderSeller> orderSellerArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderOrderShop holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("orderBy", orderBy);   //load user info
    ...
    private void loadUserInfo(ModelOrderSeller modelOrderSeller, final HolderOrderShop holder) {
